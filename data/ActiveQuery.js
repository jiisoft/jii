 ...
 * @class Jii.data.ActiveQuery
 * @extends Jii.data.Query
 */
var ActiveQuery = Jii.defineClass('Jii.data.ActiveQuery', /** @lends Jii.data.ActiveQuery.prototype */{

	__extends: Query,

	__static: /** @lends Jii.data.ActiveQuery */{
		/**

...
/**
 * @abstract
 * @class Jii.data.ActiveRecord
 * @extends Jii.data.BaseActiveRecord
 */
var ActiveRecord = Jii.defineClass('Jii.data.ActiveRecord', /** @lends Jii.data.ActiveRecord.prototype */{

	__extends: BaseActiveRecord,
	
	__static: /** @lends Jii.data.ActiveRecord */{

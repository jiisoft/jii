...
if (!process.env.JII_NO_NAMESPACE) {
    ...
    require('./comet/server/Connection.js');
    require('./comet/server/ConnectionEvent.js');
    require('./comet/server/HubServer.js');
    require('./comet/server/MessageEvent.js');
    require('./comet/server/NeatContextProfiles.js');
    require('./comet/server/NeatServer.js');
    require('./comet/server/Request.js');
    require('./comet/server/Response.js');
    require('./comet/server/Server.js');
    require('./comet/server/hub/HubInterface.js');
    require('./comet/server/hub/Redis.js');
    require('./comet/server/queue/QueueInterface.js');
    require('./comet/server/queue/Redis.js');
    require('./comet/server/transport/Sockjs.js');
    require('./comet/server/transport/TransportInterface.js');

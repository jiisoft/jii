...
Jii.defineClass('Jii.base.Component', /** @lends Jii.base.Component.prototype */{
    ...
    off(name, handler) {
        ...
        var newEvents = [];
        var isRemoved = false;
        Jii._.each(this._events[name], event => {
    ...
    trigger(name, event) {
        ...
        if (this._events && this._events[name]) {
            ...
            var isStopped = false;
            Jii._.each(this._events[name], handler => {
                if (isStopped) {
                    return;
                }
    ...
    attachBehaviors(behaviors) {
        ...
        Jii._.each(behaviors, (behavior, name) => {
    ...
    detachBehaviors() {
        ...
        Jii._.each(Jii._.keys(this._behaviors), this.detachBehavior.bind(this));
    },
    ...
    ensureBehaviors() {
        ...
        this._behaviors = [];
        Jii._.each(this.behaviors(), (behavior, name) => {
            this._attachBehaviorInternal(name, behavior);
        });
    },

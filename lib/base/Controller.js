...
Jii.defineClass('Jii.base.Controller', /** @lends Jii.base.Controller.prototype */{
	 ...
	 */
	render: function (view, context, params) {
        if (Jii._.isObject(context) && !(context instanceof Jii.base.Context)) {
            params = context;
            context = null;
        ...
        return this.getView().render(view, context, params, this).then(function(output) {
	 ...
	 * @return {Promise} the rendering result.
	 */
	renderPartial: function (view, context, params) {
        if (Jii._.isObject(context) && !(context instanceof Jii.base.Context)) {
            params = context;
            context = null;
    ...
    _findLayoutFile: function (view) {
        ...
        if (Jii._.isFunction(layoutView)) {
            return layoutView;
        }

 ...
 * ~~~
 *
 * @class Jii.request.UrlManager
 * @extends Jii.base.Component
 */
var UrlManager = Jii.defineClass('Jii.request.UrlManager', /** @lends Jii.request.UrlManager.prototype */{

	__extends: Component,

	__static: /** @lends Jii.request.UrlManager */{

		buildQuery(obj, tempKey) {
			var outputs = [];
			var cleanRegexp = /[!'()*]/g;
	...
	createUrl(route, context) {
		...
		var baseUrl = context && context.request instanceof HttpRequest ?

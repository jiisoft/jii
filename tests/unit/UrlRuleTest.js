 ...
 */
var UrlRuleTest = Jii.defineClass('UrlRuleTest', {
    ...
    _getTestsForCreateUrl() {
        ...
        return [
            ...
            ['parsing only', {pattern: 'posts', route: 'post\/index', mode: UrlRule.PARSING_ONLY}, [
                ['post\/index', {}, false]
            ]],
    ...
    _getTestsForParseRequest() {
        ...
        return [
            ...
            ['creation only', {pattern: 'posts', route: 'post\/index', mode: UrlRule.CREATION_ONLY}, [
                ['posts', false]
            ]],
            ['with param', {pattern: 'post\/<page>', route: 'post\/index'}, [
